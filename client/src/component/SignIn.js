                        ...
                        <div className="start">
                            ...
                            <div className="col-md-12">
                                ...
                                <form onSubmit={(e)=>this.onSubmitLoggin(e)}>
                                    ...
                                    <input onChange= {(e)=>this.onChangeLoggin(e)} type="email" name="email" id="inputEmail" className="form-control"  placeholder="Email Address" required />
                                    <button className="btn icon"><i className="material-icons">mail_outline</i></button>
                                    </div>
                                    <div className="form-group">
                                    <input onChange= {(e)=>this.onChangeLoggin(e)} type="password" name="password" id="inputPassword" className="form-control" placeholder="Password" required />
